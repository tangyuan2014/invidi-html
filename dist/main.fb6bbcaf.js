...
var adPlayerListener = {
  ...
  pauseContentPlayback: function pauseContentPlayback() {
    content.pause();
  ...
  illegalOperationOccurred: function illegalOperationOccurred(message) {
  ...
  openClickThrough: function openClickThrough(url) {
    window.open(url); // Tell the Ad Player the clickthrough URL was opened, so the associated VAST event can be tracked
